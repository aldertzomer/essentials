...
d <-  estimateGLMCommonDisp(d, design, as.numeric(Args[4]))
...
if (Args[3] == "tagwise") d <- estimateGLMTagwiseDisp(d, design, method="common" as.numeric(Args[4]))

if (Args[3] == "common")  glmfit.tgw <- glmFit(d, design, dispersion = d$common.dispersion)
